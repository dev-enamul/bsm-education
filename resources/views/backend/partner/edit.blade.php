    ...
    <div class="row">
        ...
        <div class="card card-primary">
            ...
            @include('backend.layouts.notification') 
                ...
                <form action="{{ route('partners.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf  
                 @method('PUT')
                    <div class="row">
                        <div class="col-md-6"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="destination_id" id="destination_id" class="form-control" required>
                                        ...
                                        @foreach ($countrys as $country)
                                            ...
                                            <option {{old('destination_id',$data->destination_id==$country->id?'selected':'')}} value="{{$country->id}}">{{$country->country}}</option>
                                        @endforeach
                                    </select> 
                                </div> 
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <img class="w-100 mb-2 mt-3" style="max-width: 215px" src="{{asset($data->image??'uploads/institutes/default.jpg')}}" alt="" id="aa"> <br>
                                <label for="image">Image <span class="text-danger"> [373 X 136]</span></label>   
