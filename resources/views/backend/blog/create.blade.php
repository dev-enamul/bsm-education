                        ...
                        <div class="col-md-6">
                            <div class="card-body pb-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  name="description" class="form-control" id="description" placeholder="Enter Description" required>{{ old('description') }}</textarea>
                                    @error('description')
                        ...
                        <div class="col-md-6">
                            <div class="card-body pb-0"> 
                                <div class="form-group">
                                    ...
                                    <input type="text" name="heading" class="form-control" id="heading" placeholder="Enter Title" value="{{ old('heading') }}" required>
                                    @error('heading')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                </div>  
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <img class="w-100 mb-2 w-100" src="{{asset('backend/images/default_blog1.jpg')}}" alt="" id="oldImg">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-5">
                                            <img class="w-100 mb-2 w-100" src="{{asset('backend/images/default_blog2.jpg')}}" alt="" id="blogDetailsImage">
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tags" class="form-control" id="tags" placeholder="e.g., (student, immigration)" value="{{ old('tags') }}">
                                    @error('tags')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                </div> 
