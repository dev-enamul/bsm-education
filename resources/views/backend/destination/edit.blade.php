            ...
            @include('backend.layouts.notification') 
                ...
                <form action="{{ route('destination.update',$data->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6"> 
                            <div class="card-body pb-0">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country" class="form-control" id="country" placeholder="Enter Title" value="{{ old('country',$data->country) }}" required>
                                    @error('country')
                                ...
                                <div class="form-group"> 
                                    ...
                                    <textarea name="short_description" id="short_description" class="form-control" cols="5" rows="3" required>{{ old('short_description',$data->short_description) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group"> 
                                <img class="w-100 mb-2 mt-3" style="max-width: 215px" src="{{asset($data->image??'uploads/destinations/destination.jpg')}}" alt="" id="aa"> <br>
                        ...
                        <div class="col-md-6"> 
                            <div class="card-body pb-0"> 
                                <div class="form-group">
                                    ...
                                    <textarea  name="reason" class="form-control" id="reason">{{ old('reason',$data->reason) }}</textarea>
                                    @error('reason')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  name="requir_document" class="form-control" id="requir_document">{{ old('requir_document',$data->requir_document) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="card-body pb-0"> 
                                <div class="form-group">
                                    ...
                                    <textarea  name="procedure" class="form-control" id="procedure">{{ old('procedure',$data->procedure) }}</textarea>
                                    @error('procedure')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea  name="fee" class="form-control" id="fee">{{ old('fee',$data->procedure) }}</textarea>
                                    @error('fee')
                                        <p class="text text-danger">{{ $message }}</p>
                                    @enderror
                                </div> 
